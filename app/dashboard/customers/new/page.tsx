...
const clientSchema = z.object({
    ...
    ContractEndDate: z.date().min(new Date(), "Гэрээний дуусах хугацаа оруулна уу."),
    ...
    DirectorRegister: z.string().min(1, "Захирлын РД оруулна уу."),
...
export default function CreateClientPage() {
    ...
    const fetchOrgData = async () => {
        // Зөвхөн байгууллагын мэдээлэл татна.
        ...
        if (!rd || rd?.length !== 7 || !regex.test(rd)) {
        ...
        try {
            ...
            const response = await clientFetcher.get<{
                ...
                customerOid: string
            }>(`/internal/taxpayer/check-by-regno?regno=${rd}`)
            if (!response.isOk) {
            ...
            if (exists) {
                tinCode = data.customerData.TinCode
                name = data.customerData.CustomerName
                vatPayer = data.customerData.vatPayer
                cityPayer = data.customerData.cityPayer
            } else {
                tinCode = data.tin
                name = data.data.name
    ...
    const fetchDirectorData = async () => {
        ...
        if (rd.length >= 10) {
            ...
            form.setValue("DrLastname", "Бат")
            form.setValue("DrFirstname", "Болд")
            setDirectorDataFetched(true)
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="py-8">
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid md:grid-cols-3 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input id="CustomerName" {...form.register("CustomerName")} readOnly className="bg-muted" />
                                    </div>
                                    <div className="space-y-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            <SelectTrigger id="clas" className="w-full">
                                                <SelectValue placeholder="Сонгох" />
                                            </SelectTrigger>
                                            <SelectContent>
                                                {taxRoles.map((role) => (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-4">
                                        <div className="space-y-2">
                                            <Label htmlFor="DirectorRegister">
                                                Иргэний РД <span className="text-destructive">*</span>
                                            </Label>
                                    ...
                                    {directorDataFetched && (
                                        <div className="grid md:grid-cols-2 gap-4">
                                            <div className="space-y-2">
                                                <Label htmlFor="DrFirstname">Овог</Label>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input id="UserName" type="UserName" {...form.register("UserName")} placeholder="example@mail.com" />
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input id="ContractEndDate" type="date" {...form.register("ContractEndDate", { valueAsDate: true })} />
                        ...
                        <div className="flex justify-end gap-3 mt-6 max-w-4xl mx-auto">
